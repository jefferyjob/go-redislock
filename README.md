...
go-redislock provides a highly scalable client adaptation mechanism, with built-in support for the following mainstream Redis clients

| Client version | Package path | Supported | Adapter method |
|---------------|--------------------------------------------------| -------- |-----------------------|
